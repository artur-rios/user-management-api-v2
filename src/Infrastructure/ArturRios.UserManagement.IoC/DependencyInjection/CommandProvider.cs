...
public static class CommandProvider
{
    ...
    {
        services.AddScoped<ICommandHandler<ActivateManyUsersCommand, ActivateManyUsersCommandOutput>, ActivateManyUsersCommandHandler>();
        services.AddScoped<ICommandHandler<ActivateUserCommand, ActivateUserCommandOutput>, ActivateUserCommandHandler>();
        services.AddScoped<ICommandHandler<AuthenticateUserCommand, AuthenticateUserCommandOutput>, AuthenticateUserCommandHandler>();
        services.AddScoped<ICommandHandler<CreateUserCommand, CreateUserCommandOutput>, CreateUserCommandHandler>();
        services.AddScoped<ICommandHandler<DeactivateManyUsersCommand, DeactivateManyUsersCommandOutput>, DeactivateManyUsersCommandHandler>();
        services.AddScoped<ICommandHandler<DeactivateUserCommand, DeactivateUserCommandOutput>, DeactivateUserCommandHandler>();
